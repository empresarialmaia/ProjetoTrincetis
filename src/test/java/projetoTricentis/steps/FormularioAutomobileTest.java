package projetoTricentis.steps;

import io.cucumber.java.After;
import io.cucumber.java.en.Given;
import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;
import projetoTricentis.pages.FormularioAutomobilePage;
import projetoTricentis.runner.Executa;
...
public class FormularioAutomobileTest {
	...
	public void deveAparecerUmaMensagemDeConfirmacaoDizendoQueOEemailFoiEnviadoComSucesso() {		
   ...
   @Then("clicar em ok para fechar o alerta de confirmacao")
	public void clicarEmOkParaFecharOAlertaDeConfirmacao() {

package projetoTricentis.pages;

import projetoTricentis.elementos.Elementos;
import projetoTricentis.metodos.Metodos;
...
public class FormularioAutomobilePage {
	...
	public void preencherDadosFormularioParte03(String startDate, String insuranceSum, String meritRating, String damageInsurance, 
		...
		if(meritRating.equalsIgnoreCase("Super Bonus")) {
			metodo.clicar(elemento.meritRatingSuperBonus);
		}else if(meritRating.equalsIgnoreCase("Bonus 1")) {
			metodo.clicar(elemento.meritRatingBonus1);			
		}else {
			metodo.clicar(elemento.meritRatingMalus10);	
		}		

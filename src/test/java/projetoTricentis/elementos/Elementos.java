package projetoTricentis.elementos;
...
public class Elementos {
	...
	public By meritRatingSuperBonus = By.xpath("//option[contains(.,'Super Bonus')]");
	public By meritRatingBonus1 = By.xpath("//option[contains(.,'Bonus 1')]");
	public By meritRatingMalus10 = By.xpath("//option[contains(.,'Malus 10')]");
